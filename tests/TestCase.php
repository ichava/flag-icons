...
namespace Simtabi\Laranail\Ichava\IconSetsFlag\Tests;
...
abstract class TestCase extends Orchestra
{
     ...
     * the configured prefix. The harness still honours `DB_CONNECTION` so that
     * `DB_CONNECTION=pgsql vendor/bin/pest` means the same thing in every PHP
     * package here, and a test that does reach the database needs no new plumbing.
     */
